...
export function ExpensesByPeriodChart({ data, dailyData = [], onYearChange }: ExpensesByPeriodChartProps) {
  const [selectedYear, setSelectedYear] = useState<string | null>(null);
  const [selectedMonth, setSelectedMonth] = useState<string | null>(null);
  const [loadingYear, setLoadingYear] = useState(false);

  const handleYearChange = useCallback(async (year: string | null) => {
    ...
    // Buscar dados do ano selecionado se necessário
  ...
  // Mostrar loading quando estiver buscando dados de outro ano
  if (loadingYear) {
    return (
      <div>
        <MonthSelector
